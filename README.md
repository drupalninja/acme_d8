...
- `$ git clone git@github.com:drupalninja/acme_d8.git`
...
## Additional Links
* [Project Drupal Theme Guide](https://bitbucket.org/mediacurrent/acme_d8.git/src/HEAD/web/themes/custom/project_theme/README.md?fileviewer=file-view-default)
